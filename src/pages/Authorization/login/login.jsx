...
const Registration = () => {
    ...
    return (
        <>
            <section className="flex justify-center flex-col mt-10 items-center">
                    ...
                    <div className="mt-10 ml-5">
                            ...
                            <div className=" flex flex-col justify-center gap-2">
                                <div className="relative">
                                    <input
                                        ...
                                        placeholder={'Создайте ник а-я, 0-9'}
                                        className="bg-[#2C2D2F] text-[#FFFFFF] text-[13px] focus:text-[#FFFFFF] rounded-md my-1 px-[60px] py-5"
                                    />
                                    <img
                                        src={imgs[0]}
                                        alt="png"
                                        className={`w-6 h-5.5 absolute ml-[12px] ${
                                            errors.nick ? `bottom-[46px]` : `bottom-[22px]`
                                        }`}
                                    />
                                    {errors.nick && (
                        ...
                        <p className="text-[#7E7E7E] mr-5 text-center">
                            ...
                            <span>
                                <br />
                                <a
                                    className="text-[#FF4B26] underline decoration-[#FF4B26]"
                                    href="#"
                                >
                                    Terms of Use
                                </a>
